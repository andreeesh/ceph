...
class MFN_Options_upload extends MFN_Options{
	...
	function render( $meta = false ){
		...
		echo '<div class="mfn-upload-field">';
			...
			echo ' <a href="javascript:void(0);" data-choose="Seleccionar un archivo" data-update="Select File" class="mfn-opts-upload" '. $upload .'><span></span>'. __('Examinar', 'mfn-opts') .'</a>';
			echo ' <a href="javascript:void(0);" class="mfn-opts-upload-remove" '. $remove .'>'.__('Eliminar', 'mfn-opts').'</a>';
