...
if( ! function_exists( 'mfn_client_post_type' ) )
{
	function mfn_client_post_type() 
	{
		...
		$labels = array(
			'name' 					=> __('Comunicados','mfn-opts'),
			'singular_name' 		=> __('Comunicado','mfn-opts'),
			'add_new' 				=> __('Nuevo','mfn-opts'),
			'add_new_item' 			=> __('Crear nuevo comunicado','mfn-opts'),
			'edit_item' 			=> __('Editar comunicado','mfn-opts'),
			'new_item' 				=> __('Nuevo','mfn-opts'),
			'view_item' 			=> __('Ver comunicados','mfn-opts'),
			'search_items' 			=> __('Buscar comunicados','mfn-opts'),
			'not_found' 			=> __('No se encontraron comunicados','mfn-opts'),
			'not_found_in_trash' 	=> __('No se encontraron comunicados en la papelera','mfn-opts'), 
			'parent_item_colon' 	=> ''
		  );
		...
		/*register_taxonomy( 'client-types', 'client', array(
			'hierarchical' 			=> true,
			'label' 				=>  __('Categorías','mfn-opts'),
			'singular_label' 		=>  __('Categoría','mfn-opts'),
			'rewrite'				=> true,
			'query_var' 			=> true
		));*/
	}
...
if( ! function_exists( 'mfn_client_edit_columns' ) )
{
	function mfn_client_edit_columns($columns)
	{
		$newcolumns = array(
			...
			"title" 				=> 'Título',
			//"client_types" 			=> __('Categoría','mfn-opts'),
			"client_order" 			=> __('Orden','mfn-opts'),
		);
...
$mfn_client_meta_box = array(
	...
	'fields' 	=> array(
		...
		array(
			...
			'type' 		=> 'upload',
			'title' 	=> __('', 'mfn-opts'),
			'sub_desc'	=> __('Archivo PDF', 'mfn-opts'),
		),
