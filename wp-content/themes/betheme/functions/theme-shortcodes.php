...
if( ! function_exists( 'sc_clients' ) )
{
	function sc_clients( $attr, $content = null )
	{
		...
		$clients_query->query( $args );
			...
			$cantidad = count($clients_query->query( $args ));
		...
		if ($clients_query->have_posts())
		{
			...
			while ($clients_query->have_posts())
			{
				...
				$output.='
				<div class="wpb_column vc_column_container vc_col-lg-6 vc_col-md-6 vc_col-sm-6 vc_col-xs-12">
					<div class="gacetilla-container">
					    <div class="icono-archivo"><img src="/wp-content/uploads/2018/01/icon-pdf.png"></div>
					    <div class="titulo-gacetilla"><h3 class="font-light mar-bot-0">'.the_title(false, false, false).'</h3></div>
					    <div class="icono-descarga"><a target="_blank" href="'.$attach_url.'"><img src="/wp-content/uploads/2018/01/download-icon.png"></a></div>
					</div>
				</div>';
